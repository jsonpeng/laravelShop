...
class RolePemessionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //积分卡设置 cards
        $cards_set = Permission::create(['name'=>'cards.*','slug'=>'system_cards_set', 'display_name'=>'积分卡设置', 'description'=>'所有页面和操作','tid'=>1,'model'=>'系统']);

        //实名认证设置 certs
        $certs_set = Permission::create(['name'=>'cards.*','slug'=>'system_certs_set', 'display_name'=>'实名认证设置', 'description'=>'所有页面和操作','tid'=>1,'model'=>'系统']);
