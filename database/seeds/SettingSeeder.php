...
class SettingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Setting::create(['name' => 'name', 'value' => '', 'group' => 'basic', 'des' => '店铺名称']);
        ...
        Setting::create(['name' => 'freight_free_limit', 'value' => '0', 'group' => 'basic', 'des' => '全场满多少免运费']);
        ...
        Setting::create(['name' => 'credits_switch', 'value' => '否', 'group' => 'credits', 'des' => '积分抵扣开关']);
        ...
        Setting::create(['name' => 'inventory_consume', 'value' => '支付成功', 'group' => 'order', 'des' => '减库存的时机  下单成功  支付成功']);
        ...
        Setting::create(['name' => 'distribution_condition', 'value' => '管理员开启', 'group' => 'distribution', 'des' => '成为分销者的方式 注册用户 购买商品 管理员开启']);
        ...
        Setting::create(['name' => 'distribution_level1_name', 'value' => '一级分销商', 'group' => 'distribution', 'des' => '一级分销商名称']);
        Setting::create(['name' => 'distribution_level1_percent', 'value' => '0', 'group' => 'distribution', 'des' => '一级分销商提成比例']);
        Setting::create(['name' => 'distribution_level2_name', 'value' => '二级分销商', 'group' => 'distribution', 'des' => '二级分销商名称']);
        Setting::create(['name' => 'distribution_level2_percent', 'value' => '0', 'group' => 'distribution', 'des' => '二级分销商提成比例']);
        Setting::create(['name' => 'distribution_level3_name', 'value' => '三级分销商', 'group' => 'distribution', 'des' => '三级分销商名称']);
