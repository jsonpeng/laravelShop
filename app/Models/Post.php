...
class Post extends Model
{
    ...
    public function products(){
        return $this->belongsToMany('App\Models\Product', 'post_product', 'post_id', 'product_id')->withPivot(['spec_price_id']);
    }

    public function specs(){
        return $this->belongsToMany('App\Models\SpecProductPrice', 'post_product', 'post_id', 'spec_price_id');
    }
