...
class CategoryRepository extends BaseRepository
{
    ...
    public function all($columns = ['*'])
    {
        return Cache::remember('all_cats', Config::get('web.cachetime'), function(){
            return Category::where('status','上线')->orderBy('sort', 'desc')->get();
        });
    }
    ...
    public function getRootCategoriesCached(){
        return Cache::remember('get_root_product_categories', Config::get('web.cachetime'), function(){
            return  Category::where('parent_id', 0)->where('status','上线')->orderBy('sort', 'desc')->get();
        });
    }
    ...
    public function getRecommendCategoriesCached(){
        return Cache::remember('get_recommend_product_categories', Config::get('web.cachetime'), function() {
            return  Category::where('recommend', 1)->where('status','上线')->orderBy('sort', 'desc')->get();
        });
    }
    ...
    public function getChildCategories($parent_id){
        return  Category::where('parent_id', $parent_id)->where('status','上线')->orderBy('sort', 'desc')->get();
    }
    ...
    public function getProductsCached($cat_id){
        return Cache::remember('get_products_of_cat_'.$cat_id, Config::get('web.cachetime'), function() use($cat_id){
            ...
            $products = $category->products()->orderBy('sort', 'desc')->with('dimensions')->get();
            return $products;
        });
    }
    */
    ...
    public function getBunchProductsCached($cat_id, $skip, $take){
        return Cache::remember('getBunchProductsCached'.'_'.$cat_id.'_'.$skip.'_'.$take, Config::get('web.cachetime'), function() use($cat_id, $skip, $take){
            ...
            $products = $category->products()->orderBy('sort', 'desc')->skip($skip)->take($take)->with('dimensions')->get();
            return $products;
        });
    }
