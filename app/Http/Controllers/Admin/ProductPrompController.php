...
class ProductPrompController extends AppBaseController
{
    ...
    public function __construct(ProductPrompRepository $productPrompRepo,ProductRepository $productRepo,SpecProductPriceRepository $specProductPriceRepo)
    {
    ...
    public function index(Request $request)
    {
        ...
        $productPromps=$productPromps->paginate($this->defaultPage());
