...
{{--         <img src="{{ asset('images/default/index/index.png') }}" alt="" class="weui-tabbar__icon">
    ...
    <a href="/category" class="weui-tabbar__item @if($tabIndex == 3) weui-bar__item_on @endif">
{{--         <img src="{{ asset('images/default/index/start.png') }}" alt="" class="weui-tabbar__icon">
    ...
    <a href="/cart" class="weui-tabbar__item @if($tabIndex == 5) weui-bar__item_on @endif">
