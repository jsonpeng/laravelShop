...
<script type="text/javascript">
	//template模板
      var previewTemplate='<div class="dz-preview dz-file-preview uploads_box"><img class="success_img" data-dz-thumbnail/><input type="hidden" name="project_images[]" value=""><span class="dz-progress"></span><div class="zhezhao" data-status="none"></div></div>';
      //上传的dom对象
      var progress_dom;
