    ...
    <div class="modal-dialog" style="width: 1000px;">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:0px; margin:0px; width: 1000px;">
                <iframe id="image2" width="1000" height="500" src="/filemanager/dialog.php?type=1&field_id=point_image" frameborder="0" style="overflow: scroll; overflow-x: hidden; overflow-y: scroll; "></iframe>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
